    ...
    sections: [
      {
        items: [
          ...
          },
          {
            ...
            path: '/drilling/performance-dashboard',
            icon: IconTrendingUp,
    ...
    sections: [
      {
        items: [
          ...
          },
          {
            ...
            path: '/qhse/activity-monitor',
            icon: IconActivity,
            menuKey: 'qhse.activity_monitor',
          },
          {
            key: 'activity_closure_analysis',
            label: 'Activity Closure Analysis',
            path: '/qhse/activity-closure-analysis',
            icon: IconTrendingUp,
    ...
    sections: [
      {
        items: [
          ...
          { key: 'email_log', label: 'Email Log', path: '/admin/email-log', icon: IconMail },
          {
            key: 'approval_codes',
            label: 'Approval Code',
            path: '/masters/approval-codes',
            icon: IconFileSignature,
            menuKey: 'masters.approval_codes',
          },
          {
            key: 'approver_mapping',
            label: 'Approver Mapping',
            path: '/admin/approver-mapping',
            icon: IconUserCheck,
            menuKey: 'admin.approver_mapping',
          },
        ],
      },
    ],
